    ...
    StandardLayout(
        ...
        Column(
            ...
            AdvancedSettingsCard(
                ...
                onPpmChange = { viewModel.onEvent(SodaCalculatorEvent.UpdatePpm(it)) },
                factorValue = state.chemicalFactor,
                onFactorChange = { viewModel.onEvent(SodaCalculatorEvent.UpdateFactor(it)) },
                factorSupportingText = "Varsayılan: ${SodaCalculatorLogic.DEFAULT_CHEMICAL_FACTOR.toInt()} (Soda için)",
